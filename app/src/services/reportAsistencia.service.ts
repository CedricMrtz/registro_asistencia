...
import {
  DatosAsistenciaResult,
  EventAttendanceRow,
  SimposiumEventRow,
  StudentAttendanceRow,
} from "@/types/reportAsistencia.types";
...
export async function getDatosAsistencia(
  idSimposium: number
): Promise<DatosAsistenciaResult> {
